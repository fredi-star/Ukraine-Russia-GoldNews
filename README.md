...
3.  **Analysis (Cheap Gemini Flash Model):** Relevant articles are sent to Google's Gemini model. I used a custom system prompt to force a structured JSON output containing sentiment, urgency (1-10), and a short reason.
